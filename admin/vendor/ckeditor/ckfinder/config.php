...
if($_SERVER['HTTP_HOST'] == 'localhost:8080' || $_SERVER['HTTP_HOST'] == 'localhost'){            
	...
	if(gethostbyaddr($_SERVER['REMOTE_ADDR']) == 'FIRSTBYTE-PC-1') { $baseUrl = '/cservices/site/';	}
	else if(gethostbyaddr($_SERVER['REMOTE_ADDR']) == 'Ruy-PC') { $baseUrl = '/cservices/source/'; }
} 
else if($_SERVER['HTTP_HOST'] == 'website.cservices.midiadesigners.local') { $baseUrl = ''; }
else if($_SERVER['HTTP_HOST'] == 'website.cservices.mediainteractive.com.br') {	$baseUrl = ''; }
else if($_SERVER['HTTP_HOST'] == 'cservices.com.br') { $baseUrl = ''; } 
else { $baseUrl = ''; }
...
if($_SERVER['HTTP_HOST'] == 'localhost:8080' || $_SERVER['HTTP_HOST'] == 'localhost'){            
	...
	if(gethostbyaddr($_SERVER['REMOTE_ADDR']) == 'FIRSTBYTE-PC-1') { $directory = 'E:/projetos/cservices/site/'; }
	else if(gethostbyaddr($_SERVER['REMOTE_ADDR']) == 'Ruy-PC') { $directory = 'C:/projetos/cservices/site/'; }
}
else if($_SERVER['HTTP_HOST'] == 'website.cservices.midiadesigners.local') { $directory = '/var/subversion/www-linux/Website_CServices/'; }
else if($_SERVER['HTTP_HOST'] == 'website.cservices.mediainteractive.com.br') { $directory = '/var/subversion/www-linux/Website_CServices_HML/'; }
else if($_SERVER['HTTP_HOST'] == 'cservices.com.br') { $directory = 'C:/inetpub/wwwroot/datamaceweb/'; } 
else { $directory = ''; }
...
$config['ResourceType'][] = Array(
		...
		'url' => $baseUrl.'files/Arquivos/',
		'directory' => $directory.'files/Arquivos',
		'maxSize' => 0,
...
$config['ResourceType'][] = Array(
		'name' => 'Imagens',
		'url' => $baseUrl.'files/Imagens/',
		'directory' => $directory.'files/Imagens/',
		'maxSize' => 0,
